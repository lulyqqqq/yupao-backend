...
import com.client.enums.TeamStatusEnum;
import com.client.exception.BusinessException;
import com.client.mapper.TeamMapper;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public boolean updateTeam(TeamUpdateRequest teamUpdateRequest, Users loginUser) {
        ...
        Team updateTeam = this.getById(id);
        BeanUtils.copyProperties(teamUpdateRequest, updateTeam);

        Date date = new Date(System.currentTimeMillis());
        updateTeam.setUpdateTime(date);
    ...
    @Transactional(rollbackFor = Exception.class)
    @Override
    public boolean quitTeam(TeamQuitRequest teamQuitRequest, Users loginUser) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public boolean deleteTeam(long id, Users loginUser) {
        // 校验队伍是否存在
